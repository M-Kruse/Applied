...
app_name = 'resume'
urlpatterns = [
	path('', login_required(views.ResumeListView.as_view()), name="resumes"),
    ...
    path('new/', login_required(views.new_resume), name="newResume"),
    path('wizard/', login_required(views.ResumeWizardView.as_view()), name="resumeWizard"),
    path('edit/<int:pk>', login_required(views.ResumeUpdateView.as_view()), name='updateResume'),
    path('delete/<int:pk>', login_required(views.ResumeDeleteView.as_view()), name='deleteResume'),
